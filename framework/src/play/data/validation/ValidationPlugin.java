...
public class ValidationPlugin extends PlayPlugin {
    ...
    public void beforeActionInvocation(Method actionMethod) {
        // (The legacy "isAwakingFromAwait" early-return was a Javaflow continuation
        // recovery hook. With await(...) now an inline block, the action runs once
        // per request and beforeActionInvocation is only called once — the check
        // would always be false, so it was removed.)
        try {
