...
public class PluginCollectionTest {
    ...
    public void verifyLoading() {
        ...
        assertThat(pc.getEnabledPlugins()).containsExactly(pc.getPluginInstance(EnhancerPlugin.class),
                ...
                pc.getPluginInstance(SecurityHeadersPlugin.class),
                pc.getPluginInstance(CorsPlugin.class),
                pc.getPluginInstance(HealthCheckPlugin.class),
                pc.getPluginInstance(play.plugins.openapi.OpenApiPlugin.class),
                pc.getPluginInstance(MetricsPlugin.class),
