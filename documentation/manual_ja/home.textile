...
## "同梱モジュール":modules#bundled
# "依存性管理":dependency
## "アプリケーションの依存性を宣言する":dependency#declaring
## "Play モジュールをロードする":dependency#modules
## "依存性の解決":dependency#resolving
## "フレームワーク自身の依存性":dependency#framework
...
# <a class="navigation" href="/@docs/api/index.html">API ドキュメント (Javadoc)</a>
