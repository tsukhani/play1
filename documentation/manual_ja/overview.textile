...
組み込みのテストランナーは <a href="http://en.wikipedia.org/wiki/Test-driven_development">テスト駆動開発</a> による作業を容易にします。JUnit を使ったユニットテストおよびファンクショナルテストを記述し、ブラウザから直接実行することができます。コードのカバレッジ率も計測されます。
