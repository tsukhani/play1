...
The @auto-test@ command does the same as the @test@ command, but it automatically launches a headless browser via Selenium/Firephoque, runs all the tests, and stops:
