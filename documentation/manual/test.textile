...
The @autotest@ command does the same as the @test@ command, but it automatically launches a headless browser via Firephoque, runs all the tests, and stops:

bc. play autotest myapp
