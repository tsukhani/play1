...
For production, replace @conf/host.cert@ and @conf/host.key@ with a real cert from Let's Encrypt, an internal CA, or your usual certificate provider. Generate self-signed certs manually with:
