...
When you want to share it with non-technical staff, or need to check it out
without a Play app running, you can render the textile files to a static HTML
bundle by invoking @play.modules.docviewer.ExportDocumentationGenerator@
directly via @play classpath@-built java command. (The @doc:export@ Python CLI
shortcut was removed in 1.13.)
