...
The default and only built-in factory is @play.db.hikaricp.HikariDataSourceFactory@. Custom factories may be supplied by implementing @play.db.DataSourceFactory@.
