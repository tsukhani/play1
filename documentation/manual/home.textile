...
Welcome to the *Play framework 1.12.x* documentation. Check the "version 1.12.x release notes":releases/release1.12.x/releasenotes-1.12.x.
...
# "OpenAPI 3 spec generation":openapi
## "Endpoints":openapi#endpoints
## "Configuration":openapi#configuration
## "Annotation reference":openapi#annotations
## "Example annotated controller":openapi#example
...
## "CORS":security#cors
## "SameSite cookies":security#samesite
...
## "Bundled modules":modules#bundled
# "Dependency management":dependency
## "Declaring application dependencies":dependency#declaring
## "Loading Play modules":dependency#modules
## "Resolving dependencies":dependency#resolving
## "Framework dependencies":dependency#framework
...
## "Structured JSON logging":logs#json
...
## "Environment variable interpolation":configuration#envvar
...
# "HTTP server, virtual threads, HTTP/2, HTTP/3":httpserver
## "HTTP/1.1, HTTP/2, and HTTP/3":httpserver#protocols
## "TLS configuration":httpserver#tls
## "Virtual threads":httpserver#virtual-threads
## "Response compression":httpserver#compression
## "Operational notes":httpserver#operational
# "Deployment options":deployment
## "Standalone Play application":deployment#standalone
## "Behind a reverse proxy":deployment#reverseproxy
# "Observability — health & metrics":observability
## "Health endpoints":observability#health
## "Metrics + Prometheus":observability#metrics
## "OTLP push":observability#otlp
...
# "Play 1.12":releases/release1.12.x/releasenotes-1.12.0
