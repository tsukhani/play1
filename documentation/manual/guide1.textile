...
p(note). The YABE tutorial walks through building the application from scratch; the snippets below are self-contained and can be copy-pasted into a new app generated with @play new myapp@.
...
@test/@ contains all the application tests. Tests are written as Java JUnit tests.
