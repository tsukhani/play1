...
| @errors@ | Validation errors | "play.data.validation.Validation.errors()":/@docs/api/play/data/validation/Validation.html#errors%28%29 | "Validating HTTP data":validation |
| @flash@ | Flash scope | "play.mvc.Scope.Flash":/@docs/api/play/mvc/Scope.Flash.html  | "Controllers - Session & Flash Scope":controllers#session |
| @lang@ | The current language | "play.i18n.Lang":/@docs/api/play/i18n/Lang.html | "Setting up I18N - Define languages":i18n#languages |
| @messages@ | The messages map | "play.i18n.Messages":/@docs/api/play/i18n/Messages.html | "Setting up I18N - Externalize messages":i18n#messages |
| @out@ | The output stream writer | java.io.PrintWriter |  |
| @params@ | Current parameters | "play.mvc.Scope.Params":/@docs/api/play/mvc/Scope.Params.html  | "Controllers - HTTP parameters":controllers#params |
| @play@ | Main framework class | "play.Play":/@docs/api/play/Play.html |  |
| @request@ | The current HTTP request | "play.mvc.Http.Request":/@docs/api/play/mvc/Http.Request.html  |  |
| @session@ | Session scope | "play.mvc.Scope.Session":/@docs/api/play/mvc/Scope.Session.html  | "Controllers - Session & Flash Scope":controllers#session |
