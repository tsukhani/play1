...
If you are running a Play application that uses one or more modules with documentation, then the local Play documentation at "http://localhost:9000/@docs":http://localhost:9000/@docs will include links to their documentation pages under *Installed Modules* in the side bar.
...
* @docviewer@ — local @/@docs@ browser; auto-loaded in dev mode
