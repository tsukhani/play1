...
Now run the @play dependencies@ command to resolve the new module dependency. If you are using IntelliJ IDEA, run `play idealize` again to refresh the project.
