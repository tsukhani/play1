...
The integrated test runner makes it easy for you do <a href="http://en.wikipedia.org/wiki/Test-driven_development">test-driven development</a>. You can write unit tests and functional tests with JUnit and run them directly from your browser. Code coverage is also measured.
