...
p(note). The starting point for this section is the YABE application built up across "guides 1–11":guide1. The goal is to fully internationalise the application, and add French and Dutch language localisations.
